<template>
    <div class="card-item bg-[var(--lightBackground)] shadow-sm duration-200 h-[100%]">
        <div class="flex flex-col p-20px justify-center items-center gap-10px">
            ...
            <h3 class="item-title md:text-size-22px text-size-20px font-700">{{ title }}</h3>
            <div class="item-des md:text-size-16px text-size-14px text-justify md:leading-normal leading-snug" v-html="description"></div>
        </div>
    </div>
</template>
<script>
