        ...
        <nav>
            ...
            <div class="navs">
                <ol>
                    ...
                    <li v-scrollanimation style="transition-delay: 400ms" @click="$router.push({ name: 'Experience' })">
                    ...
                    <li v-scrollanimation style="transition-delay: 550ms">
                        <div>
                            <a
                                href="https://drive.google.com/file/d/1QePsPyedxINA9ULzJid7MSU2y_K80tf1/view?usp=sharing"
                                target="_blank"
