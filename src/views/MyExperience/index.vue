<template>
    <section v-scrollanimation class="my-work-experience lg:mt-130px mx-auto">
        <div class="relative">
            ...
            <p class="md:text-size-20px text-size-18px md:px-10px w-[100%] max-w-[770px] md:leading-relaxed leading-relaxed">
            ...
            <div class="inner">
                <ul class="tab-list">
                    <li v-for="(exp, index) in experiences" :key="exp.company" @click="tab = index" :class="tab == index ? 'active' : ''">
                        <div>
                            <span class="md:text-size-16px text-size-14">{{ exp.tab }}</span>
                        </div>
                    </li>
                    <div
                        class="slider"
                ...
                <template v-for="(exp, index) in experiences" :key="exp.company + index">
                    <div v-scrollanimation class="company-details" v-if="tab == index">
                        ...
                        <h3 class="lg:text-size-30px md:text-size-24px text-size-22px font-700 items-center gap-7px">
                        ...
                        <div>
                            <p class="md:text-size-18px text-size-16px md:leading-normal leading-snug" v-html="exp.des"></p>
                        </div>
                    </div>
                </template>
            </div>
