<template>
    <section v-scrollanimation class="code-challenge">
        ...
        <p class="md:text-size-20px text-size-18px md:px-10px w-[100%] max-w-[770px] md:leading-relaxed leading-normal">
            {{ CodeChallenge.des }}
        </p>
        <div class="code-grid">
                        ...
                        <div class="code-item-inner">
                            <header>
                                ...
                                <div>
                                    ...
                                    <div class="md:text-size-15px text-size-12 text-justify md:leading-snug leading-tight mt-10px" v-html="code.des"></div>
                                </div>
                            </header>
